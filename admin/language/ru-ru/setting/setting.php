...
$_['text_certification_link_status_1'] = 'Показывать только если указана';
$_['text_certification_link_status_2'] = 'Если не указана, показывать дефолтное значение';
...
$_['entry_certification_link_status'] = 'Показывать ссылку на сертификат товара';
...
$_['entry_cookie'] = 'Подтверждение при входе';
...
$_['entry_seo_url_include_path'] = 'Сеоссылка на товар с категориями';
...
$_['help_cookie'] = 'Требовать подтверждение согласия с правилами при входе на сайт.';
...
$_['error_log_required'] = 'Необходимо ввести имя файла журнала ошибок!';
$_['error_log_invalid'] = 'Неверное имя файла!';
...
$_['help_mail_smtp_password'] = 'Для Gmail вам может потребоваться настроить пароль для конкретного приложения здесь: https://security.google.com/settings/security/apppasswords.';