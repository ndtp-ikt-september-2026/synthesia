<?php
$htmlPath = 'file:///' . str_replace('\\', '/', realpath(__DIR__ . '/render_perfect_rounded_logos.html'));
$rawPng = __DIR__ . '/raw_rounded_shots.png';

if (!file_exists($rawPng)) {
    die("Failed: raw screenshot not found\n");
}
echo "Captured raw screenshot: " . filesize($rawPng) . " bytes\n";
...
$names = ['logo_rounded_16', 'logo_rounded_24', 'logo_rounded_pill'];
