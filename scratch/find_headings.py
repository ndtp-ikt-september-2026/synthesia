...
with open("scratch/check_real_headings.ps1", "w", encoding="utf-8-sig") as f:
    f.write(ps_code)

res = subprocess.run(["powershell", "-ExecutionPolicy", "Bypass", "-File", "scratch/check_real_headings.ps1"], capture_output=True, text=True, encoding="utf-8", errors="replace")
print("OUTPUT:\n", res.stdout)
